...
//    
//    // MARK: Components
//    class func componentFlags() -> NSCalendarUnit { return NSCalendarUnit.YearCalendarUnit.union(.NSMonthCalendarUnit).union(.NSDayCalendarUnit).union(.NSWeekCalendarUnit).union(.NSHourCalendarUnit).union(.NSMinuteCalendarUnit).union(.NSSecondCalendarUnit) }
//    
