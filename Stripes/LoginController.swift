...
class LoginViewController: UIViewController, UIAlertViewDelegate, PFLogInViewControllerDelegate, PFSignUpViewControllerDelegate {
    ...
    func addFacebookLogin () {
        ...
        fbLoginView.addTarget(self, action: #selector(LoginViewController.fbButtonAction(_:)), forControlEvents: .TouchUpInside)
    ...
    func addLoginBtn() {
        ...
        loginBtn.addTarget(self, action: #selector(LoginViewController.loginButtonTapped(_:)), forControlEvents: UIControlEvents.TouchUpInside)
    ...
    func addRegisterBtn() {
        ...
        registerBtn.addTarget(self, action: #selector(LoginViewController.registerButtonTapped(_:)), forControlEvents: UIControlEvents.TouchUpInside)
